                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <option value="<?= $katdata['nama']; ?>"><?= $katdata['nama']; ?>"</option>                                       
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input id="kategori" name="kategori" type="text" class="form-control"  value="<?= $katdata['kategori']; ?>" placeholder="Enter here this problem" required/>
                                </div>
                            </div>
